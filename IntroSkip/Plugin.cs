...
namespace SheepIntroSkip
{
    ...
    public class Plugin
    {
        ...
        public void Init(IPA.Logging.Logger logger)
        {
            ...
            GameObject l_SongJumpController;
            (l_SongJumpController = new GameObject("SheepJumpController")).AddComponent<SongJumpController>();
            GameObject.DontDestroyOnLoad(l_SongJumpController);
        }
